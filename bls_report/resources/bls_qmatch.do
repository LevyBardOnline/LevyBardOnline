...
***
label define ychild 1 "Young Child present" 0 "No Young Child", modify
...
label define tchild 3 "3+", modify
label define tadult 3 "3+", modify
label values tchild tchild 
label values tadult tadult 
label define cpl 1 "Single" 2 "Couple", modify
label values cpl cpl 
label define hhown 0 "Renter" 1 "Home-owner", modify
...
label var tchild "No of Children"
label var tadult "No of Adults"
...
label define dchild 1 "Child Present" 0 "No Children", modify
label values dchild dchild 
label var works "Working Status"
label define works 1 "Working" 0 "Not working", modify
...
global allvar_once sex race ychild works tchild tadult age_g cpl educ_g q5 hhown 

foreach imp in rp sm mi1 {
	foreach day_end in wday wend {
		file open myfile using _`imp'_`day_end'.qmd, write replace
